                ...
                <tr>
                    ...
                    <td width="9%">
                        <button class="btn-label" style="display: flex;justify-content: center;align-items: center;">
                            <img src="../assets/images/calendar.svg" width="100%">
                        </button>
                    </td>
                </tr>
                <td colspan="4">
                            ...
                            <tr>
                                <td style="width: 25%;">
                                    <div class="dashboard-items"
                                        style="padding:20px;width:95%;display: flex; justify-content: space-between;">
                                        <div>
                                        ...
                                        <div class="btn-icon-back dashboard-icons"
                                            style="background-image: url('../assets/images/icons/doctors-hover.svg');">
                                        </div>
                                    </div>
                                </td>
                                <td style="width: 25%;">
                                    <div class="dashboard-items"
                                        ...
                                        <div class="btn-icon-back dashboard-icons"
                                            style="background-image: url('../assets/images/icons/patients-hover.svg');">
                                        </div>
                                    </div>
                                </td>
                                <td style="width: 25%;">
                                    <div class="dashboard-items"
                                        ...
                                        <div class="btn-icon-back dashboard-icons"
                                            style="margin-left: 0px;background-image: url('../assets/images/icons/book-hover.svg');">
                                        </div>
                                    </div>
                                </td>
                                <td style="width: 25%;">
                                    <div class="dashboard-items"
                                        ...
                                        <div class="btn-icon-back dashboard-icons"
                                            style="background-image: url('../assets/images/icons/session-iceblue.svg');">
                                        </div>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <td colspan="4">
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    <p
                                        style="padding:10px;padding-left:50px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                        Upcoming Appointments until Next
                                        <?= date("l", strtotime("+1 week")); ?>
                                    </p>
                                    <p
                                ...
                                <td>
                                    <p
                                        style="text-align:right;padding:10px;padding-right:55px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                        Upcoming Sessions until Next
                                        <?= date("l", strtotime("+1 week")); ?>
                                    </p>
                                    <p
                                        style="padding-bottom:19px;text-align:right;padding-right:55px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                            ...
                            <tr>
                                <td width="50%">
                                    <center>
                                        <div class="abc scroll" style="height: 100%;">
                                            <table width="85%" class="sub-table scrolldown" border="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <br><br><br><br>
                                                    <center>
                                                    <img src="../assets/images/notfound.svg" width="25%">
                                ...
                                <td>
                                    <center>
                                        <a href="appointment.php" class="non-style-link">
                                            <button class="btn-primary btn" style="width:85%">

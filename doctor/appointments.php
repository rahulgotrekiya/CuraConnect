    ...
    <div class="container">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr>
                    <td width="13%">
                        <a href="appointments.php"><button class="login-btn btn-primary-soft btn btn-icon-back"
                ...
                <!-- <tr>
                    <td colspan="4" >
                        ...
                        <a href="?action=add-session&id=none&error=0" class="non-style-link"><button  class="login-btn btn-primary btn button-icon"  style="margin-left:25px;background-image: url('../assets/images/icons/add.svg');">Add a Session</font></button>
                        </a>
                        </div>
                    </td>
                </tr> -->
        ...
        if ($action == 'add-session') {
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a class="close" href="sessions.php">&times;</a> 
                        <div style="display: flex;justify-content: center;">
                        <div class="abc">
            ...
            <div id="popup1" class="overlay">
                    ...
                    <br><br>
                        ...
                        <a href="sessions.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;OK&nbsp;&nbsp;</font></button></a>
                        <br><br><br><br>
                        </div>
                    </center>
            </div>

    ...
    <div class="container">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr>
                    <td width="13%">
                        <a href="sessions.php"><button class="login-btn btn-primary-soft btn btn-icon-back"
        ...
        if ($action == 'drop') {
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a href="sessions.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
